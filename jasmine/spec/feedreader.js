...
$(function () {
    ...
    describe('The menu', function () {
        ...
        it('should be toggled visibility on click', function () {
            menuBtn.click();
            expect(body.hasClass('menu-hidden')).toBe(false); // show menu
            menuBtn.click();
            expect(body.hasClass('menu-hidden')).toBe(true); // hide menu
        });
    });
    ...
    describe('New Feed Selection', function () {
        ...
        beforeEach(function (done) {
            loadFeed(0, function () {
                oldFeed = $('.feed').html(); // store old feed
